...
public class ManualLookUpPage {
    ...
    public static void click_car_btn() {
        common.wait_for_element_xpath(car_btn);
        driver.findElement(By.xpath(car_btn)).click();
    }

    public static void click_paint_btn() {
        common.wait_for_element_to_be_enable("xpath", paint_type_bnt);
    ...
    public static void manufacturer_select_dropdown() {
        common.wait_for_element_to_be_enable("id", manufacturer_dropdown);
    ...
    public static void model_select_dropdown() {
        common.wait_for_element_to_be_enable("id", model_dropdown);
    ...
    public static void fuel_type_select_dropdown() {
        common.wait_for_element_to_be_enable("id", fuel_type_dropdown);
    ...
    public static void year_select_dropdown() {
        common.wait_for_element_to_be_enable("id", reg_year_dropdown);
    ...
    public static void colour_select_dropdown() {
        common.wait_for_element_to_be_enable("id", colour_dropdown);
    ...
    public static void derivative_select_dropdown() {
        common.wait_for_element_to_be_enable("id", derivative_dropdown);
